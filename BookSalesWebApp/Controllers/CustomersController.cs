...
namespace BookSalesWebApp.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(BookSalesWebAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var customer = await _context.Customer.Include(b => b.BookSales)
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FirstName,LastName,Address1,Address2,City,Province,Country,PostalCode")] Customer customer)
        {
            if (id != customer.ID)
            {
                return NotFound();
